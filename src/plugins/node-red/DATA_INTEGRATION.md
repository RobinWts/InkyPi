# Node-RED Data Integration Approaches
...
1. **JSON Parsing Mode** (default) - Node-RED sends JSON, plugin parses and displays according to layout configuration
2. **HTML Mode** - Node-RED sends complete HTML, plugin renders it directly
